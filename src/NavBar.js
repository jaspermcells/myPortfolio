...
function NavBar() {
	return (
		<div
			className=" lg:h-20 bg-black drop-shadow-lg grid lg:grid-cols-2 text-slate-200 justify-items-center items-center justify-center sm:grid-cols-1 sm:h-60 md:h-50 z-50 shadow-white

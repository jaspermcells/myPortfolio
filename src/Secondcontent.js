...
function Secondcontent() {
	...
	return (
		<div className="bg-black lg:top-40 md:top-18 w-full m-auto h-full z-50 relative mt-72 grid grid-cols-1  justify-items-center ">
			...
			<div className="  grid lg:grid-cols-2 lg:w-3/4 md:w-1/2 sm:w-1/2 md:grid-cols-1 sm:grid-cols-1   bg-black p-0  z-50 	">
					...
					<Slider {...settings}>
						<div>
							<img
								src={melvin1}
								alt=""
								className="w-full h-1/2 rounded-l-2xl "
							/>
						</div>
						<div>
							<img
				...
				<div className=" bg-red-800 backdrop-opacity-95  w-full h-auto  font-bold text-center    rounded-r-2xl grid grid-cols-1 text-white drop-shadow-xl gap-0  relative ">
					...
					<ul className=" grid  justify-items-start font-NanumBrush justify-start text-start  ml-14 lg:text-2xl md:text-lg  list-outside ">
